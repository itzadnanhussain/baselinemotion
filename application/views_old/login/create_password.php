...
<head>
  ...
  <title>Create Password | Baseline Motion</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <h3 class="login-box-msg primary-color">Create Password</h3>
    <?php
    $attributes = array('class' => 'resetpw-form', 'id' => 'resetpw-form');
    echo form_open('login/verify_reset_password_code', $attributes);
    ?>
    <?php 
    echo form_error('reset_password_code'); 
    ...
    ?>
		<div class="form-group has-feedback">
			<?php
				...
				echo form_password(array('id' => 'password', 'name' => 'password', 'class' => 'form-control', 'placeholder' => 'Please Enter New Password', 'autocomplete' => 'off', 'required' => 'required'), $password);
            ?>
			<input type="hidden" name="user_id" value='<?php echo $_REQUEST['user_id']; ?>'>
			<input type="hidden" name="reset_password_code" value='<?php echo $_REQUEST['token']; ?>'>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
		
        <div class="form-group has-feedback">
			<?php
				$conf_password = set_value('conf_password', NULL);
				echo form_password(array('id' => 'conf_password', 'name' => 'conf_password', 'class' => 'form-control', 'placeholder' => 'Please Re-Enter New Password', 'autocomplete' => 'off', 'required' => 'required'), $conf_password);
            ?>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
        </div>
	...
	<p class="text-center">If you already have an account,<br/> please <a href="<?=base_url(); ?>login" class="underlineborder">CLICK HERE</a> to login.</p>
    <!-- /.social-auth-links -->
