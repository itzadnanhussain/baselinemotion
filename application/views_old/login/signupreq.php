...
<head>
  ...
  <title>Sign Up | Baseline Motion</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <?php
    $attributes = array('class' => 'signup-form', 'id' => 'signup-form', 'novalidate'=>'novalidate');
    echo form_open('login/validatesignup', $attributes);
    ?>
    <?php 
    ...
    ?>
        ...
        <?php
			$username = set_value('name', NULL);
            echo form_input(array('name' => 'name', 'class' => 'form-control', 'placeholder' => 'Name', 'autocomplete' => 'off', 'required' => 'required'), $username);
            ?>
        ...
        <?php
            ...
            echo form_input(array('name' => 'email', 'class' => 'form-control', 'placeholder' => 'Email', 'autocomplete' => 'off', 'required' => 'required'), $username);
            ?>
            <!-- <input type="email" class="form-control" placeholder="Email"> -->
        ...
        <div class="form-group has-feedback">
			<?php
				$notes = set_value('notes', NULL);
				echo form_textarea(array('name' => 'notes', 'class' => 'form-control', 'placeholder' => 'Notes', 'autocomplete' => 'off'), $notes);
            ?>
