...
<?php } ?>
<script>selectedlink = 'managecombinemenulink'; </script>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Combine</li>
      </ol>
    </section>
    ...
    <section class="content">
		<div class="container box">
			<form method="post" id="add_combines" enctype="multipart/form-data">
			...
			<br />
			<div id="imported_combine_data"></div>
		</div>
...
<div style="clear:both;"></div>
<style>
#imported_combine_data iframe{
	max-width:200px;
	max-height:150px;
}

#add_combines textarea {
    width: 100%;
    height: 120px;
    padding: 10px;
}
