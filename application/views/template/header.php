		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li id="checklistmenu">
						<a href="<?= base_url() ?>pre_event/checklist">
							<span>Pre Event Checklist</span>
						</a>
					</li>

					<li id="combinescoreslinkmenu">
						<a href="<?= base_url() ?>combine_scores/scores">
							<span>Combine Scores</span>
						</a>
					</li>
					...
					<?php if ($this->session->userdata("user_type") == 2) { ?>
						...
						<li id="managechecklist">
							<a href="<?= base_url() ?>pre_event/manage_checklist">
								<span>Manage Checklist</span>
							</a>
						</li>
						<li id="managecombinemenulink">
							<a href="<?= base_url() ?>combine_scores">
								<span>Manage Combine</span> 
							</a>
						</li>
						...
						<li class="treeview">
							...
							<ul class="treeview-menu" style=""> 
								<!-- <li><a href="<?= base_url() ?>rules/kams"> KAMS Rules</a></li> -->
								<li><a href="<?= base_url() ?>rules/posture"> Posture Rules</a></li>
								<li><a href="<?= base_url() ?>rules/functional"> Functional Rules</a></li>
								<li><a href="<?= base_url() ?>rules/rom"> ROM Rules</a></li>
								<li><a href="<?= base_url() ?>rules/overhead"> Overhead Rules</a></li>
								<li><a href="<?= base_url() ?>rules/wallangel"> Posture Angel Rules</a></li>
								<li><a href="<?= base_url() ?>rules/reverselunge"> Reverse Lunge Rules</a></li>
							</ul>
						</li>
					<?php } ?>
					<li class="">
